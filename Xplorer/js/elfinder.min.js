	...
	elFinder.prototype.ui.prototype.commands = {
		...
		**/
		reload: function (fm) {
			...
			this.exec = function () {
				this.fm.ajax({ cmd: 'reload', target: this.fm.cwd.hash, tree: true }, function (data) {
					self.fm.reload(data);
				});
			}
		...
		**/
		upload: function (fm) {
			...
			this.exec = function () {
				...
				f = '<form method="post" enctype="multipart/form-data" action="' + self.fm.options.url + '" target="' + id + '"><input type="hidden" name="cmd" value="upload" /><input type="hidden" name="current" value="' + self.fm.cwd.hash + '" /><input type="hidden" name="ud" value="' + fm.options.dirPath + '" />',
		...
		**/
		...
		help: function (fm) {
			...
			this.exec = function () {
				...
				tabs = '<div id="el-finder-help-h"><p>' + h + '</p></div>'
